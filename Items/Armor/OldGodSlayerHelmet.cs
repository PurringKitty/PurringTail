...
namespace PurringTail.Content.Items.Armor
{
	...
	public class OldGodSlayerHelmet : ModItem
	{
		...
		public static readonly int AdditiveMeleeDamageBonus = 2;
		...
		public override void UpdateArmorSet(Player player) {
			...
			player.GetDamage(DamageClass.Generic) += AdditiveGenericDamageBonus / 10f; // Increase dealt damage for all weapon classes by 20%
		}
        ...
        public override void AddRecipes()
        {
			...
			recipe.AddIngredient<RustiumBar>(21);
