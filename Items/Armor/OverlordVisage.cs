...
namespace PurringTail.Content.Items.Armor
{
	...
	public class OverlordVisage : ModItem
	{
        ...
        public static readonly int AdditiveMeleeDamageBonus = 5;
                    ...
                    public override void UpdateArmorSet(Player player)
        {
            ...
            player.GetDamage(DamageClass.Generic) += AdditiveGenericDamageBonus / 20f; // Increase dealt damage for all weapon classes by 20%
