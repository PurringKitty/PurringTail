...
namespace PurringTail.Content.Items.Armor
{
	...
	{
        public static int AdditiveSummonDamageBonus = 15;
        public static int MaxSentryIncrease = 2;
        public static int MaxWhipRange = 15;
                    ...
                    public override void UpdateArmorSet(Player player)
        {
            ...
            player.GetDamage(DamageClass.Generic) += AdditiveSummonDamageBonus / 20f; // Increase dealt damage for all weapon classes by 20%
