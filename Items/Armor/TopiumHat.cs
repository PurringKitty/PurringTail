...
namespace PurringTail.Content.Items.Armor
{
	...
	public class TopiumHat : ModItem
	{
        public static readonly int AdditiveRangedDamageBonus = 15;
        ...
        public override void SetStaticDefaults()
        {
            ...
            SetBonusText = this.GetLocalization("SetBonus").WithFormatArgs(AdditiveRangedDamageBonus);
        }
                    ...
                    public override void UpdateArmorSet(Player player)
        {
            ...
            player.GetDamage(DamageClass.Generic) += AdditiveRangedDamageBonus / 20f; // Increase dealt damage for all weapon classes by 20%
