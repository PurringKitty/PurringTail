...
public class TopHatDemonPendent : ModItem
{
    ...
    public static readonly int SummonCritBonus = 2;
    public static readonly int SummonAttackSpeedBonus = 100;
    public static readonly int MagicArmorPenetration = 25;

    // Insert the modifier values into the tooltip localization. More info on this approach can be found on the wiki: https://github.com/tModLoader/tModLoader/wiki/Localization#binding-values-to-localizations
    public override LocalizedText Tooltip => base.Tooltip.WithFormatArgs(AdditiveSummonDamageBonus, MaxManaIncrease, SummonCritBonus, SummonAttackSpeedBonus, MagicArmorPenetration);
    ...
    public override void UpdateAccessory(Player player, bool hideVisual)
    {
        ...
        player.GetDamage(DamageClass.Summon) += SummonCritBonus;
        ...
        player.GetCritChance(DamageClass.Summon) += SummonCritBonus;
        ...
        player.GetAttackSpeed(DamageClass.Summon) += SummonCritBonus;
